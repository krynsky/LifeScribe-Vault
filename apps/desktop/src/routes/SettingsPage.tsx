...
/**
 * Settings route shell. Loads the bundled base pack for its module definitions
 * and renders the generic Vault options section. Future settings sections
 * (e.g. change master password) stack below as siblings.
 */
